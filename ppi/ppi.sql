...
CREATE TABLE `interactions` (
  ...
  CONSTRAINT inter_pk PRIMARYKEY(`Id_interactor_A`,`Id_interactor_B`),
  CONSTRAINT inter_fk FOREIGN KEY (`Id_interactor_A`,`Id_interactor_B`) REFERENCES protein(`Accession`)
